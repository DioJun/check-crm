export default function WhatsAppButton({ telefone, nome, className = '' }) {
  ...
  return (
    <a
      ...
      className={`inline-flex items-center gap-1.5 px-3 py-1.5 bg-green-500 hover:bg-green-600 text-white text-sm font-medium rounded-lg transition-colors ${className}`}
      title={`WhatsApp ${nome}`}
    >
      <svg
